...
import 'package:deliveryapplicacion/controladores/menu_controller.dart';
  ...
  Widget _swiperTarjetas(Size size) {
    /*final List<Menu> menus = [
      Menu(
          ...
          nombre: "Menu 1",
          descripcion:
              "Descripcion del Menu N° 1 Descripcion del Menu N° 1 Descripcion del Menu N° 1 Descripcion del Menu N° 1 Descripcion del Menu N° 1 Descripcion del Menu N° 1 Descripcion del Menu N° 1 Descripcion del Menu N° 1",
          precio: 1.99,
          imagen:
              "https://d1ralsognjng37.cloudfront.net/939dd856-2cbe-4226-9246-b790337190d9.jpeg"),
      Menu(
          idMenu: '2',
          nombre: "Menu 2",
          descripcion: "Descripcion del Menu N° 2",
          precio: 2.99,
          imagen:
              "https://scontent.fsal3-1.fna.fbcdn.net/v/t1.0-9/117826099_1164528353913227_4355133303312654781_o.jpg?_nc_cat=111&_nc_sid=8bfeb9&_nc_ohc=kcFhDkTyz8sAX8Z6jUw&_nc_ht=scontent.fsal3-1.fna&oh=6d021ab23c15a86f2c2f37f4f3717670&oe=5FB2709C"),
      Menu(
          idMenu: '3',
          nombre: "Menu 3",
          descripcion: "Descripcion del Menu N° 3",
          precio: 1.75,
          imagen:
      ...
      Menu(
          idMenu: '4',
          nombre: "Menu 4",
          descripcion: "Descripcion del Menu N° 4",
          precio: 3.80,
          imagen:
